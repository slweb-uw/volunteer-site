	...
	return (
		<div>
			...
			>
				...
				{/* Top options bar (opportuny type -> Signup only switch) */}
				<Grid container columns={16} spacing={2}>
					...
					{/* Provider view and signup switches */}
					<Grid item xs={12} md={3}>
						<Stack direction="row" spacing={1}>
							...
							/>
							<Typography style={{ display: 'flex', alignItems: 'center' }}>
								<b style={{ marginRight: '0.25rem', fontSize: '1rem' }}>Signup Only</b>
								<Tooltip
									title={
										<Typography>
											Show only projects which provide direct sign up.
										</Typography>
									}
								>
									<InfoOutlinedIcon style={{ fontSize: '1.5 rem', color: "#808080" }} />
