...
const SignupEventPopup = ({ open, close, mode, event, handleEventAction }) => {
  ...
  const handleSubmit = () => {
    ...
    if (startDateTime <= now) {
      alert("Please select a future start date and time for the event.");
      return;
    }
...
// Implement validation for date and time inputs, 
// specifically around the following edge cases: 
// end date occurring before start date, start date 
// occuring before today's date, or any other cases with 
// unexpected behavior.
