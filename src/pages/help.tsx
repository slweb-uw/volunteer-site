    ...
    <div className={classes.page}>
      ...
      >
        ...
        >
          ...
          >
            You will be presented with a pop-up, promting to sign-in with an
            email account. Use your email to sign in with either a Google or
            Microsoft account. <br />
            If you are using a UW email (an email ending in @uw.edu), you can
            use either the Google or Microsoft option to sign in.
          </Typography>
          <img
            style={{
              width: "60em",
          ...
          >
            After signing in, the Sign In button on the top right will have
            changed to sign out. You can click this button at anytime to sign
            out.
          </Typography>
        </MuiAccordionDetails>
      </MuiAccordion>
      ...
      >
        ...
        >
          ...
          >
            Don't worry if the page is blank, it's not broken! Make sure a valid
            location is selected in the Location drop-down menu.
          </Typography>
          <img
            style={{
              width: "60em",
          ...
          >
            You can find all avalible projects at the selected location, as well
            as their relative information.
          </Typography>
        </MuiAccordionDetails>
      </MuiAccordion>
      <MuiAccordion
      ...
      >
        ...
        >
          <Typography className={classes.title}>
            How to sign up/volunteer for a project/Opportunity event
          </Typography>
        </MuiAccordionSummary>
        <MuiAccordionDetails
          style={{
        ...
        >
          ...
          >
            Once you find a project that interests you on the oppertunities
            page, click on it to open a pop-up.
          </Typography>
          <img
            style={{
              width: "60em",
          ...
          >
            Here, you can view all of the details listed about the specific
            volunteer opportunity. For further details, you can visit the
            specific opportunity’s website link. <br />
            If you are ready to join, you can find the project lead's contact
            information in the Project Lead Contact List.
          </Typography>
        </MuiAccordionDetails>
      </MuiAccordion>
      ...
      >
        ...
        >
          ...
          >
            Once you are on the signup page, you're screen should look similar
            to the above image. <br />
