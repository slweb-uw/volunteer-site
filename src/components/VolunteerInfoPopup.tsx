      ...
      >
        ...
        <DialogContent className={classes.information}>
          <Typography variant="body1" className={classes.item}>
            <span className={classes.label}>Name</span> {volunteer.firstName}{" "}
            {volunteer.lastName}
          </Typography>
          <Typography variant="body1" className={classes.item}>
          ...
          <Typography variant="body1" className={classes.item}>
            <span className={classes.label}>Student Discipline</span>{" "}
            {volunteer.studentDiscipline}
          </Typography>
          {volunteer.comments && (
            <Typography
              variant="body1"
              className={`${classes.item} ${classes.comments}`}
            >
          ...
          <Button
            variant="outlined"
            color="secondary"
            onClick={() => handleDelete(volunteer, "remove")}
          >
            Remove Volunteer
          </Button>
        </DialogContent>
